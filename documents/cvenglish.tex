...
\item Assistant Professor in the Department of Computer Science at the University of Chile.  \\
\item Young Researcher at Millennium Institute for Foundational Research on Data (Funded by Programa Milenio, Chile).  \\
\item Honorary Research Associate in the Machine Learning Group at the University of Waikato, New Zealand. 
\end{CV}
...
\item F. Bravo-Marquez, E. Frank, B. Pfahringer, and S. M. Mohammad \textit{AffectiveTweets: a WEKA Package for Analyzing Affect in Tweets}, In  \textit{Journal of Machine Learning Research} 20(92): Pages 1−6, 2019. 

\item S. Lang, F. Bravo-Marquez, C. Beckham, M. Hall, and E. Frank \textit{WekaDeeplearning4j: a Deep Learning Package for Weka based on DeepLearning4j}, In  \textit{Knowledge-Based Systems}, Volume 178, 15 August 2019, Pages 48-50. 
...
\item A. Ansell, F. Bravo-Marquez, and B. Pfahringer  \textit{An ELMo-inspired approach to SemDeep-5's Word-in-Context task}. In  \textit{Proceedings of the 5th Workshop on Semantic Deep Learning (SemDeep-5)} co-located with IJCAI 2019 in Macau, China. 

\item D. Trye, A. S. Calude, F. Bravo-Marquez, and T. T Keegan  \textit{Māori Loanwords: A Corpus of New Zealand English Tweets}. In  \textit{Proceedings of the 2019 ACL Student Research Workshop (SRW)}, Florence, Italy. 
...
\item [Fall 2018] (Lecturer) Data Mining (CC5306), University of Chile.
