...
\begin{frame}{Phonetics and phonology}

\begin{itemize}
 \item Phonetics studies the sounds of a language \cite{JohnsonMLSS}
\begin{itemize}
\item E.g., [t] and [d] differ in voice onset time 
\item E.g., English aspirates stop consonants in certain positions (e.g., [t$^{h}$op] vs. [stop])
\end{itemize}
\item Phonology studies the distributional properties of these sounds
\begin{itemize}
\item E.g., the English noun plural is [s] following unvoiced segments and [z]
following voiced segments
\item E.g., English speakers pronounce /t/ differently (e.g., in water)
\end{itemize}
...
\begin{itemize}
 \item Morphology studies the structure of words \cite{JohnsonMLSS}
\begin{itemize}
\item E.g.,re+structur+ing, un+remark+able
\end{itemize}
\item Derivational morphology exhibits hierarchical structure
\begin{itemize}
\item Example: re+vital+ize+ation
     \begin{figure}[h]
        	\includegraphics[scale = 0.25]{pics/morphology.png}
        \end{figure}
\item The suffix usually determines the syntactic category of the derived word        
